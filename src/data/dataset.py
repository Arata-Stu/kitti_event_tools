...
def build_stream_dataset(data_dir: Path, seq_names: list, ev_repr_name: str, seq_len: int):
    """
    ...
    streaming_sequences = [
        SequenceForStreaming(data_dir, seq_name, ev_repr_name, seq_len)
...
def build_random_dataset(data_dir: Path, ev_repr_name: str, seq_len: int, seq_ids: list = None):
    """
    ...
    return RandomConcatDataset(data_dir, ev_repr_name, seq_len, seq_ids)
